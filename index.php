            ...
            <div class="container-fluid align-items-center justify-content-center h-100">
                <div class="row d-flex justify-content-center text-center">
                    <div class="col-md-10">
                        ...
                        <a type="button" class="btn btn-outline-white" href="https://github.com/PixPMusic/AltRepo">Github<i class="fa fa-book ml-2"></i></a>
                        <a type="button" class="btn btn-outline-white" href="altstore://source?url=https://repo.pixp.cc/repo.json">Add to AltStore<i class="fa fa-book ml-2"></i></a>
