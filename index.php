...
<body>
    ...
    <p>The source is available on <a href="https://github.com/PixPMusic/AltRepo">Github</a> and the URL to add to AltRepo is <a href="http://repo.potatotoast.com/repo.json">http://repo.potatotoast.com/repo.json</a></p>
</body>